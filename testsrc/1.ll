...
define i32 @zjlnb(i32 %arg_0, i32 %arg_1, i32 %arg_2, i32 %arg_3, i32 %arg_4, i32 %arg_5, i32 %arg_6, i32 %arg_7, i32 %arg_8, i32 %arg_9, float %arg_10) {
LEntry:
    %v0 = alloca i32
    %v1 = alloca i32
    %v2 = alloca i32
...
LEntry:
    ...
    store i32 7, i32* %v6
    store i32 8, i32* %v7
    %v8 = call i32 @zjlnb(i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, float 0x4026000000000000)
    store i32 %v8, i32* %v0
    %v9 = load i32, i32* %v0
    ret i32 %v9
}
