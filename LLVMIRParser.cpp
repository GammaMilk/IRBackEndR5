...
void llvmirParserInitialize() {
  ...
  auto staticData = std::make_unique<LLVMIRParserStaticData>(
    std::vector<std::string>{
      "compilationUnit", "topLevelEntity", "globalDecl", "globalDef", "immutable", 
      "funcDecl", "funcDef", "funcHeader", "funcBody", "basicBlock", "instruction", 
      "terminator", "localDefInst", "mathInstruction", "valueInstruction", 
      "storeInst", "allocaInst", "loadInst", "getElementPtrInst", "bitCastInst", 
      "zExtInst", "sExtInst", "siToFpInst", "fpToSiInst", "iCmpInst", "fCmpInst", 
      "callInst", "retTerm", "brTerm", "condBrTerm", "floatType", "concreteType", 
      "value", "constant", "boolConst", "intConst", "floatConst", "arrayConst", 
      "type", "intType", "pointerType", "labelType", "arrayType", "namedType", 
      "params", "param", "label", "iPred", "args", "arg", "zeroInitializerConst", 
      "fPred"
    },
    std::vector<std::string>{
      "", "'='", "'constant'", "'global'", "'declare'", "'define'", "'('", 
      "')'", "'{'", "'}'", "'add'", "','", "'fadd'", "'sub'", "'fsub'", 
      "'mul'", "'fmul'", "'udiv'", "'sdiv'", "'fdiv'", "'urem'", "'srem'", 
      "'frem'", "'store'", "'alloca'", "'load'", "'getelementptr'", "'bitcast'", 
      "'to'", "'zext'", "'sext'", "'sitofp'", "'fptosi'", "'icmp'", "'fcmp'", 
      "'call'", "'ret'", "'void'", "'br'", "'float'", "'true'", "'false'", 
      "'['", "']'", "'*'", "'label'", "'x'", "'eq'", "'ne'", "'sge'", "'sgt'", 
      "'sle'", "'slt'", "'uge'", "'ugt'", "'ule'", "'ult'", "'zeroinitializer'", 
      "'oeq'", "'oge'", "'ogt'", "'ole'", "'olt'", "'one'", "'ord'", "'ueq'", 
      "'une'", "'uno'"
    },
    std::vector<std::string>{
      "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", 
      ...
      "LocalIdent", "LabelIdent", "IntType"
    }
  );
  static const int32_t serializedATNSegment[] = {
  	4,1,76,487,2,0,7,0,2,1,7,1,2,2,7,2,2,3,7,3,2,4,7,4,2,5,7,5,2,6,7,6,2,
  	...
  	1,1,1,1,1,1,3,1,117,8,1,1,2,1,2,1,2,1,2,1,2,1,3,1,3,1,3,1,3,1,3,1,3,1,
  	4,1,4,1,5,1,5,1,5,1,6,1,6,1,6,1,6,1,7,1,7,1,7,1,7,1,7,1,7,1,8,1,8,4,8,
  	147,8,8,11,8,12,8,148,1,8,1,8,1,9,3,9,154,8,9,1,9,5,9,157,8,9,10,9,12,
  	9,160,9,9,1,9,1,9,1,10,1,10,1,10,3,10,167,8,10,1,11,1,11,1,11,3,11,172,
  	8,11,1,12,1,12,1,12,1,12,1,13,1,13,1,13,1,13,1,13,1,13,1,13,1,13,1,13,
  	1,13,1,13,1,13,1,13,1,13,1,13,1,13,1,13,1,13,1,13,1,13,1,13,1,13,1,13,
  	1,13,1,13,1,13,1,13,1,13,1,13,1,13,1,13,1,13,1,13,1,13,1,13,1,13,1,13,
  	1,13,1,13,1,13,1,13,1,13,1,13,1,13,1,13,1,13,1,13,1,13,1,13,1,13,1,13,
  	1,13,1,13,1,13,1,13,1,13,1,13,1,13,1,13,1,13,1,13,1,13,1,13,1,13,1,13,
  	1,13,1,13,1,13,1,13,1,13,1,13,1,13,3,13,250,8,13,1,14,1,14,1,14,1,14,
  	1,14,1,14,1,14,1,14,1,14,1,14,1,14,1,14,3,14,264,8,14,1,15,1,15,1,15,
  	1,15,1,15,1,15,1,15,1,16,1,16,1,16,1,16,1,16,1,16,3,16,279,8,16,1,17,
  	1,17,1,17,1,17,1,17,1,17,1,18,1,18,1,18,1,18,1,18,1,18,1,18,1,18,1,18,
  	5,18,296,8,18,10,18,12,18,299,9,18,1,19,1,19,1,19,1,19,1,19,1,19,1,20,
  	...
  	1,26,1,26,1,27,1,27,1,27,1,27,1,27,1,27,3,27,358,8,27,1,28,1,28,1,28,
  	1,29,1,29,1,29,1,29,1,29,1,29,1,29,1
  	0,462,461,1,0,0,0,462,463,1,0,0,0,463,91,1,0,0,0,464,465,5,45,0,0,465,
  	466,5,74,0,0,466,93,1,0,0,0,467,468,7,2,0,0,468,95,1,0,0,0,469,474,3,
  	98,49,0,470,471,5,11,0,0,471,473,3,98,49,0,472,470,1,0,0,0,473,476,1,
  	0,0,0,474,472,1,0,0,0,474,475,1,0,0,0,475,478,1,0,0,0,476,474,1,0,0,0,
  	477,469,1,0,0,0,477,478,1,0,0,0,478,97,1,0,0,0,479,480,3,62,31,0,480,
  	481,3,64,32,0,481,99,1,0,0,0,482,483,5,57,0,0,483,101,1,0,0,0,484,485,
  	7,3,0,0,485,103,1,0,0,0,25,107,116,148,153,158,166,171,249,263,278,297,
  	357,378,383,390,407,410,421,430,432,455,458,462,474,477
  };
...
LLVMIRParser::FuncBodyContext* LLVMIRParser::funcBody() {
  ...
  try {
    ...
    do {
      ...
      ((1ULL << _la) & 412048421888) != 0) || _la == LLVMIRParser::LocalIdent
...
LLVMIRParser::BasicBlockContext* LLVMIRParser::basicBlock() {
  ...
  try {
    ...
    _la = _input->LA(1);
    while ((((_la & ~ 0x3fULL) == 0) &&
      ((1ULL << _la) & 68451038208) != 0) || _la == LLVMIRParser::LocalIdent) {
      setState(155);
      instruction();
      setState(160);
      _errHandler->sync(this);
...
LLVMIRParser::MathInstructionContext::MathInstructionContext(ParserRuleContext *parent, size_t invokingState)
  : ParserRuleContext(parent, invokingState) {
}
...
LLVMIRParser::SdivInstContext::SdivInstContext(MathInstructionContext *ctx) { copyFrom(ctx); }
...
LLVMIRParser::FremInstContext::FremInstContext(MathInstructionContext *ctx) { copyFrom(ctx); }
...
LLVMIRParser::AddInstContext::AddInstContext(MathInstructionContext *ctx) { copyFrom(ctx); }
...
LLVMIRParser::FsubInstContext::FsubInstContext(MathInstructionContext *ctx) { copyFrom(ctx); }
...
LLVMIRParser::FdivInstContext::FdivInstContext(MathInstructionContext *ctx) { copyFrom(ctx); }
...
LLVMIRParser::SremInstContext::SremInstContext(MathInstructionContext *ctx) { copyFrom(ctx); }
...
LLVMIRParser::UdivInstContext::UdivInstContext(MathInstructionContext *ctx) { copyFrom(ctx); }
...
LLVMIRParser::UremInstContext::UremInstContext(MathInstructionContext *ctx) { copyFrom(ctx); }
...
LLVMIRParser::MulInstContext::MulInstContext(MathInstructionContext *ctx) { copyFrom(ctx); }
...
LLVMIRParser::FaddInstContext::FaddInstContext(MathInstructionContext *ctx) { copyFrom(ctx); }
...
LLVMIRParser::SubInstContext::SubInstContext(MathInstructionContext *ctx) { copyFrom(ctx); }
...
LLVMIRParser::FmulInstContext::FmulInstContext(MathInstructionContext *ctx) { copyFrom(ctx); }
...
LLVMIRParser::MathInstructionContext* LLVMIRParser::mathInstruction() {
  MathInstructionContext *_localctx = _tracker.createInstance<MathInstructionContext>(_ctx, getState());
...
LLVMIRParser::MathInstruction_Context::MathInstruction_Context(ValueInstructionContext *ctx) { copyFrom(ctx); }

void LLVMIRParser::MathInstruction_Context::enterRule(tree::ParseTreeListener *listener) {
  auto parserListener = dynamic_cast<LLVMIRListener *>(listener);
  if (parserListener != nullptr)
    parserListener->enterMathInstruction_(this);
}
void LLVMIRParser::MathInstruction_Context::exitRule(tree::ParseTreeListener *listener) {
  auto parserListener = dynamic_cast<LLVMIRListener *>(listener);
  if (parserListener != nullptr)
    parserListener->exitMathInstruction_(this);
}
...
LLVMIRParser::AllocaInst_Context::AllocaInst_Context(ValueInstructionContext *ctx) { copyFrom(ctx); }

void LLVMIRParser::AllocaInst_Context::enterRule(tree::ParseTreeListener *listener) {
  auto parserListener = dynamic_cast<LLVMIRListener *>(listener);
  if (parserListener != nullptr)
    parserListener->enterAllocaInst_(this);
}
void LLVMIRParser::AllocaInst_Context::exitRule(tree::ParseTreeListener *listener) {
  auto parserListener = dynamic_cast<LLVMIRListener *>(listener);
  if (parserListener != nullptr)
    parserListener->exitAllocaInst_(this);
}
...
LLVMIRParser::ICmpInst_Context::ICmpInst_Context(ValueInstructionContext *ctx) { copyFrom(ctx); }

void LLVMIRParser::ICmpInst_Context::enterRule(tree::ParseTreeListener *listener) {
  auto parserListener = dynamic_cast<LLVMIRListener *>(listener);
  if (parserListener != nullptr)
    parserListener->enterICmpInst_(this);
}
void LLVMIRParser::ICmpInst_Context::exitRule(tree::ParseTreeListener *listener) {
  auto parserListener = dynamic_cast<LLVMIRListener *>(listener);
  if (parserListener != nullptr)
    parserListener->exitICmpInst_(this);
}
...
LLVMIRParser::SiToFpInst_Context::SiToFpInst_Context(ValueInstructionContext *ctx) { copyFrom(ctx); }

void LLVMIRParser::SiToFpInst_Context::enterRule(tree::ParseTreeListener *listener) {
  auto parserListener = dynamic_cast<LLVMIRListener *>(listener);
  if (parserListener != nullptr)
    parserListener->enterSiToFpInst_(this);
}
void LLVMIRParser::SiToFpInst_Context::exitRule(tree::ParseTreeListener *listener) {
  auto parserListener = dynamic_cast<LLVMIRListener *>(listener);
  if (parserListener != nullptr)
    parserListener->exitSiToFpInst_(this);
}
...
LLVMIRParser::BitCastInst_Context::BitCastInst_Context(ValueInstructionContext *ctx) { copyFrom(ctx); }

void LLVMIRParser::BitCastInst_Context::enterRule(tree::ParseTreeListener *listener) {
  auto parserListener = dynamic_cast<LLVMIRListener *>(listener);
  if (parserListener != nullptr)
    parserListener->enterBitCastInst_(this);
}
void LLVMIRParser::BitCastInst_Context::exitRule(tree::ParseTreeListener *listener) {
  auto parserListener = dynamic_cast<LLVMIRListener *>(listener);
  if (parserListener != nullptr)
    parserListener->exitBitCastInst_(this);
}
...
LLVMIRParser::ZExtInst_Context::ZExtInst_Context(ValueInstructionContext *ctx) { copyFrom(ctx); }

void LLVMIRParser::ZExtInst_Context::enterRule(tree::ParseTreeListener *listener) {
  auto parserListener = dynamic_cast<LLVMIRListener *>(listener);
  if (parserListener != nullptr)
    parserListener->enterZExtInst_(this);
}
void LLVMIRParser::ZExtInst_Context::exitRule(tree::ParseTreeListener *listener) {
  auto parserListener = dynamic_cast<LLVMIRListener *>(listener);
  if (parserListener != nullptr)
    parserListener->exitZExtInst_(this);
}
...
LLVMIRParser::CallInst_Context::CallInst_Context(ValueInstructionContext *ctx) { copyFrom(ctx); }

void LLVMIRParser::CallInst_Context::enterRule(tree::ParseTreeListener *listener) {
  auto parserListener = dynamic_cast<LLVMIRListener *>(listener);
  if (parserListener != nullptr)
    parserListener->enterCallInst_(this);
}
void LLVMIRParser::CallInst_Context::exitRule(tree::ParseTreeListener *listener) {
  auto parserListener = dynamic_cast<LLVMIRListener *>(listener);
  if (parserListener != nullptr)
    parserListener->exitCallInst_(this);
}
...
LLVMIRParser::FCmpInst_Context::FCmpInst_Context(ValueInstructionContext *ctx) { copyFrom(ctx); }

void LLVMIRParser::FCmpInst_Context::enterRule(tree::ParseTreeListener *listener) {
  auto parserListener = dynamic_cast<LLVMIRListener *>(listener);
  if (parserListener != nullptr)
    parserListener->enterFCmpInst_(this);
}
void LLVMIRParser::FCmpInst_Context::exitRule(tree::ParseTreeListener *listener) {
  auto parserListener = dynamic_cast<LLVMIRListener *>(listener);
  if (parserListener != nullptr)
    parserListener->exitFCmpInst_(this);
}
...
LLVMIRParser::LoadInst_Context::LoadInst_Context(ValueInstructionContext *ctx) { copyFrom(ctx); }

void LLVMIRParser::LoadInst_Context::enterRule(tree::ParseTreeListener *listener) {
  auto parserListener = dynamic_cast<LLVMIRListener *>(listener);
  if (parserListener != nullptr)
    parserListener->enterLoadInst_(this);
}
void LLVMIRParser::LoadInst_Context::exitRule(tree::ParseTreeListener *listener) {
  auto parserListener = dynamic_cast<LLVMIRListener *>(listener);
  if (parserListener != nullptr)
    parserListener->exitLoadInst_(this);
}
...
LLVMIRParser::GEPInst_Context::GEPInst_Context(ValueInstructionContext *ctx) { copyFrom(ctx); }

void LLVMIRParser::GEPInst_Context::enterRule(tree::ParseTreeListener *listener) {
  auto parserListener = dynamic_cast<LLVMIRListener *>(listener);
  if (parserListener != nullptr)
    parserListener->enterGEPInst_(this);
}
void LLVMIRParser::GEPInst_Context::exitRule(tree::ParseTreeListener *listener) {
  auto parserListener = dynamic_cast<LLVMIRListener *>(listener);
  if (parserListener != nullptr)
    parserListener->exitGEPInst_(this);
}
...
LLVMIRParser::FpToSiInst_Context::FpToSiInst_Context(ValueInstructionContext *ctx) { copyFrom(ctx); }

void LLVMIRParser::FpToSiInst_Context::enterRule(tree::ParseTreeListener *listener) {
  auto parserListener = dynamic_cast<LLVMIRListener *>(listener);
  if (parserListener != nullptr)
    parserListener->enterFpToSiInst_(this);
}
void LLVMIRParser::FpToSiInst_Context::exitRule(tree::ParseTreeListener *listener) {
  auto parserListener = dynamic_cast<LLVMIRListener *>(listener);
  if (parserListener != nullptr)
    parserListener->exitFpToSiInst_(this);
}
...
LLVMIRParser::SExtInst_Context::SExtInst_Context(ValueInstructionContext *ctx) { copyFrom(ctx); }

void LLVMIRParser::SExtInst_Context::enterRule(tree::ParseTreeListener *listener) {
  auto parserListener = dynamic_cast<LLVMIRListener *>(listener);
  if (parserListener != nullptr)
    parserListener->enterSExtInst_(this);
}
void LLVMIRParser::SExtInst_Context::exitRule(tree::ParseTreeListener *listener) {
  auto parserListener = dynamic_cast<LLVMIRListener *>(listener);
  if (parserListener != nullptr)
    parserListener->exitSExtInst_(this);
}
...
std::vector<LLVMIRParser::ConcreteTypeContext *> LLVMIRParser::GetElementPtrInstContext::concreteType() {
  return getRuleContexts<LLVMIRParser::ConcreteTypeContext>();
}
