...
public:
  enum {
    ...
    WhiteSpace = 69, IntLit = 70, FloatLit = 71, StringLit = 72, GlobalIdent = 73, 
    LocalIdent = 74, LabelIdent = 75, IntType = 76
  };

  enum {
    RuleCompilationUnit = 0, RuleTopLevelEntity = 1, RuleGlobalDecl = 2, 
    RuleGlobalDef = 3, RuleImmutable = 4, RuleFuncDecl = 5, RuleFuncDef = 6, 
    RuleFuncHeader = 7, RuleFuncBody = 8, RuleBasicBlock = 9, RuleInstruction = 10, 
    RuleTerminator = 11, RuleLocalDefInst = 12, RuleMathInstruction = 13, 
    RuleValueInstruction = 14, RuleStoreInst = 15, RuleAllocaInst = 16, 
    RuleLoadInst = 17, RuleGetElementPtrInst = 18, RuleBitCastInst = 19, 
    RuleZExtInst = 20, RuleSExtInst = 21, RuleSiToFpInst = 22, RuleFpToSiInst = 23, 
    RuleICmpInst = 24, RuleFCmpInst = 25, RuleCallInst = 26, RuleRetTerm = 27, 
    RuleBrTerm = 28, RuleCondBrTerm = 29, RuleFloatType = 30, RuleConcreteType = 31, 
    RuleValue = 32, RuleConstant = 33, RuleBoolConst = 34, RuleIntConst = 35, 
    RuleFloatConst = 36, RuleArrayConst = 37, RuleType = 38, RuleIntType = 39, 
    RulePointerType = 40, RuleLabelType = 41, RuleArrayType = 42, RuleNamedType = 43, 
    RuleParams = 44, RuleParam = 45, RuleLabel = 46, RuleIPred = 47, RuleArgs = 48, 
    RuleArg = 49, RuleZeroInitializerConst = 50, RuleFPred = 51
  };
